...
class FileRLibraryProvider(backend.LibraryProvider):
    ...
    def __init__(self, backend, config):
        super(FileRLibraryProvider, self).__init__(backend)
    ...
    def browse(self, uri):
        ...
        for dp, null, fn in os.walk(local_path, followlinks=True):
            for dir_entry in fn:
                child_path = os.path.join(dp, dir_entry)
